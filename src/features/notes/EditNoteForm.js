...
const EditNoteForm = ({ note, users }) => {
    ...
    let assignOption = null;
    if (isManager || isAdmin) {
        assignOption = (
            <div className="mb-3">
                <label htmlFor="selectOption" className="form-label text-dark">
                    ASSIGNED TO
                </label>
                <select
                    id="note-username"
                    ...
                    <div className="card shadow-no mt-3">
                        <div className="card-body">
                            <form className="form-controll" onSubmit={onSaveNoteClicked}>
                                <div className="mb-3">
                                    <label htmlFor="titleInput" className="form-label text-dark">
                                        Judul
                                    </label>
                                    <input
                                        type="text"
                                ...
                                <div className="mb-3">
                                    <label htmlFor="textInput" className="form-label text-dark">
                                        Konten
                                    </label>
                                    <textarea
